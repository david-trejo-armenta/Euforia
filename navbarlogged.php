        ...
        <div class="navbar-nav ">
          ...
          <li class="nav-item dropleft ">
            ...
            <div class="dropdown-menu dropleft">
                ...
                <a class="dropdown-item .dropdown" href="profile.php">Profile</a><br>
            <div class="dropdown-divider"></div>
                <a class="dropdown-item .dropdown" href="shoppinghistory.php">History</a><br>
            <div class="dropdown-divider"></div>
                 <a class="dropdown-item .dropdown" href="favorites.php">Wishlist</a><br>
            <div class="dropdown-divider"></div>
          ...
          <li class="nav-item dropleft ">
            ...
            <div class="dropdown-menu p-1 text-muted border-none">
              ...
              <a class="dropdown-item" href="shoppingcart.php">Load Shopping Cart</a>
            </div>
        </div>
