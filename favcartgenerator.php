...
function favgen($order_id,$user_id,$product_id,$name,$price,$size,$image,$quantity){ 
    echo ' <br><br>
    ...
    <div class="row no-gutters">
        ...
        <div class=" col-md-8">
            <div class="card-body">
                ...
                <button type="submit" class="btn btn-primary float-left" name="deletefav" id="submit"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-star" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
